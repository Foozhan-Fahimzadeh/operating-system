...
; 0000 0029 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 002A DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(15)
	OUT  0x17,R30
; 0000 002B // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=0 Bit1=0 Bit0=0
...
; 0000 0035 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=Out Bit1=Out Bit0=Out
; 0000 0036 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(7)
	OUT  0x11,R30
; 0000 0037 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=0 Bit1=0 Bit0=0
...
_0xD:
	...
	CPC  R5,R0
	BRLT _0xE
; 0000 008F             PORTA = i%10;
	RCALL SUBOPT_0x0
; 0000 0090             PORTB = i/10;
...
_0x16:
	...
	CPC  R5,R0
	BRLT _0x17
; 0000 0099             PORTA = i%10;
	RCALL SUBOPT_0x0
; 0000 009A             PORTB = i/10;
...
_0x1F:
	...
	CPC  R5,R0
	BRLT _0x20
; 0000 00A4             PORTA = i%10;
	RCALL SUBOPT_0x0
; 0000 00A5             PORTB = i/10;
